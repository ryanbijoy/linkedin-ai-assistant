...
export default function Chatbot() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (isLinkedInUrl && !profileLoaded) {
        ...
        const response = await fetch('https://0f0cfdf861db.ngrok-free.app/analyze-profile', {
          method: 'POST',
          headers: {
        ...
        const response = await fetch('https://0f0cfdf861db.ngrok-free.app/chat', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const handleJobFitAnalysis = async () => {
    ...
    try {
      const response = await fetch('https://0f0cfdf861db.ngrok-free.app/job-fit-analysis', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleContentEnhancement = async () => {
    ...
    try {
      const response = await fetch('https://0f0cfdf861db.ngrok-free.app/content-enhancement', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleCareerGuidance = async () => {
    ...
    try {
      const response = await fetch('https://0f0cfdf861db.ngrok-free.app/career-guidance', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
